...
## Features
### Core Features
- **Create/Delete/Edit Profiles**: Maintain a digital "rolodex" of closest connections, with details like hobbies, struggles, and birthdays.
...
1. Ensure that you have the Expo Go app installed on your mobile device.
2. Scan the QR code generated by npm start to open the app on your device.
